...
\textbf{Usage:} - \\
\textbf{Reflection:} As creation of tables in LaTeX is pretty verbose it saved some time, as it handles columns, formats, size, crossreferences, .... The actual text content however was changed manually by myself.\\

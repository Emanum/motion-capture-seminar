...
DeMoCap \ref{method_democap} present their realtime marker based approach which uses low-cost depth sensors.
XNect \ref{method_xnect} can track multiple persons in realtime from a single camera similar to OpenPose but for a 3D skeleton.

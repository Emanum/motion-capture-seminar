...
This is addressed in their next publication with Part Affinity Fields \cite{openPose_3_cao2017real-time}. A bottom-up approach is used. This means that first body parts are detected and afterwards assigned to an unknown number of people in the image.
...
Occlusion of the neck of a person result in the entire person not being detected irregarding if large parts of the body is detected. Close human interactions like hugging also leads to inaccurate results. 
...
They train their network on a pure synthetic dataset which simulating their 33 camera studio setup, consisting of single person scenes, complex interaction scenes including dance scenes with two persons and a subset focusing on hand articulations. \\

...
To achieve as much accuracy as possible, traditional state-of-the-art motion capturing studios use suits equipped with markers together with large quantity of high resolution and high frame rate camera systems in a multi view setup combined. This is often referred to as the "gold standard" in literature.
...
Therefore, many state-of-the-art motion capture systems in the industry and approaches in research use a large amount of cameras to cover as many angles as possible.

...
\begin{tabularx}{1.4\textwidth} { 
 ...
 \hline
 \textbf{EasyMocap} \cite{easymocap} \cite{shuai2022multinb} \cite{lin2022efficient} \cite{dong2021fast} \cite{dong2020motion} \cite{peng2021neural} \cite{fang2021mirrored} & & & & \\
 \hline

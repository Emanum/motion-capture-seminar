...
Open Questions:\\
cite inside the sentence like this \cite{menache_understanding_2000}. Or outside like this. \cite{menache_understanding_2000}
\\
How to quote URLs for tech specs, articles, products, ...
...
A first step is tracking which can be done with model-based, region-based or feature-based methods \cite{wang_recent_2003}. Afterwards, multi-view geometry is applied to do 3D pose estimation. 
...
Therefore, many state-of-the-art motion capture systems in the industry as well approaches in research use a large amount of cameras to cover as many angles as possible \cite{wang_recent_2003}.

\hfill 

While multi-camera methods still produce the most accurate results among many approaches, they also pose some significant downsides.
...
The focus of these systems targets towards high portability, lower costs and application in dynamic environments compared to classical high accuracy systems installed in permanent motion capture studios.